...
const PirlsResults = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
       setLoading(true);
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/pirls_results/');
                ...
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center">المتوسط الدولي</TableCell>
                         ...
                         <TableCell align="center">وزارة التربية والتعليم</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                {results.map(result => (
