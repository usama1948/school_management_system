...
const NationalQualityResults = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      setLoading(true);
      try {
        const response = await axios.get('http://127.0.0.1:8000/api/national_test_results/');
  ...
  return (
    <div>
      <h3>نتائج اختبار ضبط النوعية</h3>
...
export default NationalQualityResults;